      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate">
            ...
            <p>
              <img src="<?= url('themes/'. $themeInfo->value)?>/images/image_1.jpg" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="<?= url('themes/'. $themeInfo->value)?>/images/image_2.jpg" alt="" class="img-fluid">
            </p>
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio align-self-md-center mr-4">
                <img src="<?= url('themes/'. $themeInfo->value)?>/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
              </div>
            ...
            <div class="pt-5 mt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="<?= url('themes/'. $themeInfo->value)?>/images/person_1.jpg" alt="Image placeholder">
                  </div>
