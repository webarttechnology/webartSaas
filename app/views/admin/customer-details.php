								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_65a1214a764fd">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_65a1214a764fd" data-allow-clear="true">
																<option></option>
												...
												<div class="card-body pt-2">
													...
													<div class="py-2">
														...
														<div class="d-flex flex-stack">
															<div class="d-flex">
																<img src="<?=  url('/admin') ?>/assets/media/svg/brand-logos/google-icon.svg" class="w-30px me-6" alt="" />
														...
														<div class="d-flex flex-stack">
															<div class="d-flex">
																<img src="<?=  url('/admin') ?>/assets/media/svg/brand-logos/github.svg" class="w-30px me-6" alt="" />
																<div class="d-flex flex-column">
														...
														<div class="d-flex flex-stack">
															<div class="d-flex">
																<img src="<?=  url('/admin') ?>/assets/media/svg/brand-logos/slack-icon.svg" class="w-30px me-6" alt="" />
																<div class="d-flex flex-column">
														...
														<div class="card-body pt-0 pb-5">
															...
															<table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_payment">
																...
																<tbody class="fs-6 fw-semibold text-gray-600">
																	<tr>
																		...
																		<td class="pe-0 text-end">
																			...
																			<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																				<!--begin::Menu item-->
																				<div class="menu-item px-3">
																					<a href="<?= url('/dw-admin/customer-details') ?>" class="menu-link px-3">View</a>
																				</div>
																				<!--end::Menu item-->
																				<!--begin::Menu item-->
																				<div class="menu-item px-3">
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">2624-4361</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">9766-6474</a>
																		</td>
																		<td>
																			<span class="badge badge-light-success">Successful</span>
																		</td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">8537-2736</a>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<a href="#" class="text-gray-600 text-hover-primary mb-1">9380-9424</a>
																		</td>
																		<td>
																			<span class="badge badge-light-warning">Pending</span>
																		</td>
															...
															<div class="py-0" data-kt-customer-payment-method="row">
																...
																<div class="py-3 d-flex flex-stack flex-wrap">
																	...
																	<div class="d-flex align-items-center collapsible rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_1" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_1">
																		...
																		<!--end::Arrow-->
																		<!--begin::Logo-->
																		<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/mastercard.svg" class="w-40px me-3" alt="" />
																		<!--end::Logo-->
																		<!--begin::Summary-->
																		<div class="me-3">
																			...
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					...
																					<div class="symbol symbol-20px symbol-circle ms-2">
																						<img src="<?=  url('/admin') ?>/assets/media/flags/australia.svg" />
																					</div></td>
																				</tr>
																				<tr>
															...
															<div class="py-0" data-kt-customer-payment-method="row">
																...
																<div class="py-3 d-flex flex-stack flex-wrap">
																	...
																	<div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_2" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_2">
																		...
																		<!--end::Arrow-->
																		<!--begin::Logo-->
																		<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/visa.svg" class="w-40px me-3" alt="" />
																		<!--end::Logo-->
																		<!--begin::Summary-->
																		<div class="me-3">
																			<div class="d-flex align-items-center">
																		...
																		<div class="flex-equal">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					...
																					<div class="symbol symbol-20px symbol-circle ms-2">
																						<img src="<?=  url('/admin') ?>/assets/media/flags/united-kingdom.svg" />
																					</div></td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">CVC check</td>
															...
															<div class="py-0" data-kt-customer-payment-method="row">
																...
																<div class="py-3 d-flex flex-stack flex-wrap">
																	...
																	<div class="d-flex align-items-center collapsible collapsed rotate" data-bs-toggle="collapse" href="#kt_customer_view_payment_method_3" role="button" aria-expanded="false" aria-controls="kt_customer_view_payment_method_3">
																		...
																		<!--end::Arrow-->
																		<!--begin::Logo-->
																		<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/american-express.svg" class="w-40px me-3" alt="" />
																		<!--end::Logo-->
																		<!--begin::Summary-->
																		<div class="me-3">
																			<div class="d-flex align-items-center">
																		...
																		<div class="flex-equal">
																			<table class="table table-flush fw-semibold gy-1">
																				...
																				<tr>
																					...
																					<div class="symbol symbol-20px symbol-circle ms-2">
																						<img src="<?=  url('/admin') ?>/assets/media/flags/united-states.svg" />
																					</div></td>
																				</tr>
																				<tr>
																					<td class="text-muted min-w-125px w-125px">CVC check</td>
														...
														<div class="d-flex flex-column mb-7 fv-row">
															...
															<div class="position-relative">
																...
																<div class="position-absolute translate-middle-y top-50 end-0 me-5">
																	<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/visa.svg" alt="" class="h-25px" />
																	<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/mastercard.svg" alt="" class="h-25px" />
																	<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/american-express.svg" alt="" class="h-25px" />
																</div>
																<!--end::Card logos-->
															</div>
															<!--end::Input wrapper-->
