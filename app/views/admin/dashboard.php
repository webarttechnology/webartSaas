		...
		<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
			...
			<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
				...
				<div class="d-flex align-items-center gap-2 gap-lg-3">
					...
					<a href="<?= url('/dw-admin/order-list'); ?>" class="btn btn-sm fw-bold btn-secondary">Manage Sales</a>
					<!--end::Secondary button-->
					<!--begin::Primary button-->
					<a href="<?= url('/dw-admin/add-product'); ?>" class="btn btn-sm fw-bold btn-primary">Add Product</a>
					<!--end::Primary button-->
				</div>
				<!--end::Actions-->
			</div>
							...
							<div class="card-body d-flex flex-column justify-content-end pe-0">
								...
								<div class="symbol-group symbol-hover flex-nowrap">
									...
									<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
										<img alt="Pic" src="<?= url('/admin/') ?>/assets/media/avatars/300-11.jpg" />
									</div>
									...
									<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Barry Walter">
										<img alt="Pic" src="<?= url('/admin/') ?>/assets/media/avatars/300-12.jpg" />
									</div>
								...
								<ul class="nav nav-pills nav-pills-custom mb-3">
									...
									<li class="nav-item mb-3 me-3 me-lg-6">
										...
										<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_1">
											<!--begin::Icon-->
											<div class="nav-icon">
												<img alt="" src="<?= url('/admin/') ?>/assets/media/svg/products-categories/t-shirt.svg" class="" />
											</div>
											<!--end::Icon-->
											<!--begin::Subtitle-->
									...
									<li class="nav-item mb-3 me-3 me-lg-6">
										...
										<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_2">
											<!--begin::Icon-->
											<div class="nav-icon">
												<img alt="" src="<?= url('/admin/') ?>/assets/media/svg/products-categories/gaming.svg" class="" />
											</div>
											<!--end::Icon-->
											<!--begin::Subtitle-->
									...
									<li class="nav-item mb-3 me-3 me-lg-6">
										...
										<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_3">
											<!--begin::Icon-->
											<div class="nav-icon">
												<img alt="" src="<?= url('/admin/') ?>/assets/media/svg/products-categories/watch.svg" class="" />
											</div>
											<!--end::Icon-->
											<!--begin::Subtitle-->
									...
									<li class="nav-item mb-3 me-3 me-lg-6">
										...
										<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_4">
											<!--begin::Icon-->
											<div class="nav-icon">
												<img alt="" src="<?= url('/admin/') ?>/assets/media/svg/products-categories/gloves.svg" class="nav-icon" />
											</div>
											<!--end::Icon-->
											<!--begin::Subtitle-->
									...
									<li class="nav-item mb-3">
										...
										<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_5">
											<!--begin::Icon-->
											<div class="nav-icon">
												<img alt="" src="<?= url('/admin/') ?>/assets/media/svg/products-categories/shoes.svg" class="nav-icon" />
											</div>
											<!--end::Icon-->
											<!--begin::Subtitle-->
										...
										<div class="table-responsive">
											...
											<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
												...
												<tbody>
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/210.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant
																1802</a>
													...
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/215.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red
																Laga</a>
															<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item:
																#XDG-1321</span>
														</td>
													...
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/209.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
															<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item:
																#XDG-4312</span>
														</td>
														<td>
										...
										<div class="table-responsive">
											...
											<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
												...
												<tbody>
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/197.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant
																1802</a>
													...
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/178.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red
																Laga</a>
													...
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/22.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
															<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item:
										...
										<div class="table-responsive">
											...
											<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
												...
												<tbody>
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/1.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant
																1324</a>
													...
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/24.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red
																Laga</a>
													...
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/71.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
															<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item:
										...
										<div class="table-responsive">
											...
											<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
												...
												<tbody>
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/41.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant
																2635</a>
													...
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/63.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red
																Laga</a>
													...
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/59.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
															<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item:
										...
										<div class="table-responsive">
											...
											<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
												...
												<tbody>
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/10.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Nike</a>
															<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item:
																#XDG-2163</span>
														</td>
														<td>
													...
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/96.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Adidas</a>
															<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item:
																#XDG-2162</span>
														</td>
														<td>
													...
													<tr>
														<td>
															<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/13.png" class="w-50px ms-n1" alt="" />
														</td>
														<td class="ps-0">
															<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Puma</a>
															<span class="text-gray-500 fw-semibold fs-7 d-block text-start ps-0">Item:
																#XDG-1537</span>
														</td>
														<td>
							...
							<div class="card-body d-flex flex-column flex-center">
								...
								<div class="mb-2">
									...
									<div class="py-10 text-center">
										<img src="<?= url('/admin/') ?>/assets/media/svg/illustrations/easy/2.svg" class="theme-light-show w-200px" alt="" />
										<img src="<?= url('/admin/') ?>/assets/media/svg/illustrations/easy/2-dark.svg" class="theme-dark-show w-200px" alt="" />
									</div>
									<!--end::Illustration-->
								</div>
								<!--end::Heading-->
								...
								<div class="text-center mb-1">
									<!--begin::Link-->
									<a class="btn btn-sm btn-primary me-2" href="<?= url('/dw-admin/product') ?>">View App</a>
									<!--end::Link-->
									<!--begin::Link-->
									<a class="btn btn-sm btn-light" href="<?= url('/dw-admin/add-product') ?>">New Product</a>
									<!--end::Link-->
								</div>
								<!--end::Links-->
							</div>
							...
							<div class="card-body pt-2">
								...
								<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_4_table">
									...
									<tbody class="fw-bold text-gray-600">
											...
											<td colspan="2">
												<div class="d-flex align-items-center gap-3">
													<a href="#" class="symbol symbol-50px bg-secondary bg-opacity-25 rounded">
														<img src="" data-kt-src-path="<?= url('/admin/') ?>/assets/media/stock/ecommerce/" alt="" data-kt-table-widget-4="template_image" />
													</a>
										...
										<tr>
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary">#XGY-346</a>
											</td>
										...
										<tr>
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary">#YHD-047</a>
											</td>
										...
										<tr>
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary">#SRR-678</a>
											</td>
										...
										<tr>
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary">#PXF-534</a>
											</td>
										...
										<tr>
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary">#XGD-249</a>
											</td>
										...
										<tr>
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary">#SKP-035</a>
											</td>
											<td class="text-end">2 day ago</td>
											<td class="text-end">
										...
										<tr>
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary">#SKP-567</a>
											</td>
											<td class="text-end">7 min ago</td>
											<td class="text-end">
					...
					<div class="col-xl-4">
						...
						<div class="card card-flush h-xl-100">
							...
							<div class="card-header pt-7">
								...
								<!--begin::Toolbar-->
								<div class="card-toolbar">
									<a href="<?= url('/dw-admin/edit-product') ?>" class="btn btn-sm btn-light">Order Details</a>
								</div>
								<!--end::Toolbar-->
							</div>
							<!--end::Header-->
								...
								<div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
									...
									<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
										...
										<div class="d-flex flex-stack mb-3">
											...
											<div class="me-3">
												<!--begin::Icon-->
												<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/210.png" class="w-50px ms-n1 me-1" alt="" />
												<!--end::Icon-->
												<!--begin::Title-->
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">Elephant
													1802</a>
												<!--end::Title-->
											</div>
											<!--end::Wrapper-->
										...
										<div class="d-flex flex-stack">
											...
											<span class="text-gray-500 fw-bold">To:
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">Jason
													Bourne</a></span>
											<!--end::Name-->
											<!--begin::Label-->
									...
									<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
										...
										<div class="d-flex flex-stack mb-3">
											...
											<div class="me-3">
												<!--begin::Icon-->
												<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/209.png" class="w-50px ms-n1 me-1" alt="" />
												<!--end::Icon-->
												<!--begin::Title-->
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">RiseUP</a>
												<!--end::Title-->
											</div>
											<!--end::Wrapper-->
											<!--begin::Action-->
										...
										<div class="d-flex flex-stack">
											<!--begin::Name-->
											<span class="text-gray-500 fw-bold">To:
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">Marie
													Durant</a></span>
											<!--end::Name-->
											<!--begin::Label-->
									...
									<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
										...
										<div class="d-flex flex-stack mb-3">
											...
											<div class="me-3">
												<!--begin::Icon-->
												<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/214.png" class="w-50px ms-n1 me-1" alt="" />
												<!--end::Icon-->
												<!--begin::Title-->
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">Yellow
													Stone</a>
												<!--end::Title-->
											</div>
											<!--end::Wrapper-->
										...
										<div class="d-flex flex-stack">
											<!--begin::Name-->
											<span class="text-gray-500 fw-bold">To:
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">Dan
													Wilson</a></span>
											<!--end::Name-->
											<!--begin::Label-->
									...
									<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
										...
										<div class="d-flex flex-stack mb-3">
											...
											<div class="me-3">
												<!--begin::Icon-->
												<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/211.png" class="w-50px ms-n1 me-1" alt="" />
												<!--end::Icon-->
												<!--begin::Title-->
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">Elephant
													1802</a>
										...
										<div class="d-flex flex-stack">
											<!--begin::Name-->
											<span class="text-gray-500 fw-bold">To:
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">Lebron
													Wayde</a></span>
											<!--end::Name-->
											<!--begin::Label-->
											<span class="badge badge-light-success">Delivered</span>
									...
									<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
										...
										<div class="d-flex flex-stack mb-3">
											...
											<div class="me-3">
												<!--begin::Icon-->
												<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/215.png" class="w-50px ms-n1 me-1" alt="" />
												<!--end::Icon-->
												<!--begin::Title-->
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">RiseUP</a>
												<!--end::Title-->
										...
										<div class="d-flex flex-stack">
											<!--begin::Name-->
											<span class="text-gray-500 fw-bold">To:
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">Ana
													Simmons</a></span>
											<!--end::Name-->
											<!--begin::Label-->
											<span class="badge badge-light-primary">Shipping</span>
									...
									<div class="border border-dashed border-gray-300 rounded px-7 py-3">
										...
										<div class="d-flex flex-stack mb-3">
											...
											<div class="me-3">
												<!--begin::Icon-->
												<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/192.png" class="w-50px ms-n1 me-1" alt="" />
												<!--end::Icon-->
												<!--begin::Title-->
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">Yellow
													Stone</a>
										...
										<div class="d-flex flex-stack">
											<!--begin::Name-->
											<span class="text-gray-500 fw-bold">To:
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-800 text-hover-primary fw-bold">Kevin
													Leonard</a></span>
											<!--end::Name-->
											<!--begin::Label-->
											<span class="badge badge-light-danger">Confirmed</span>
						...
						<div class="card card-flush h-xl-100">
							...
							<div class="card-header pt-7">
								...
								<h3 class="card-title align-items-start flex-column">
									...
									<span class="text-gray-500 mt-1 fw-semibold fs-6">Total 2,356 Items
										in the Stock</span>
								</h3>
								<!--end::Title-->
								<!--begin::Actions-->
								<div class="card-toolbar">
									...
									<div class="d-flex flex-stack flex-wrap gap-4">
										...
										<!--end::Status-->
										<!--begin::Search-->
										<a href="products.php" class="btn btn-light btn-sm">View Stock</a>
										<!--end::Search-->
									</div>
									<!--begin::Filters-->
								</div>
								...
								<table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
									...
									<tbody class="fw-bold text-gray-600">
										<tr>
											<!--begin::Item-->
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-900 text-hover-primary">Macbook Air
													M1</a>
											</td>
											<!--end::Item-->
											<!--begin::Product ID-->
										...
										<tr>
											<!--begin::Item-->
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-900 text-hover-primary">Surface
													Laptop 4</a>
											</td>
											<!--end::Item-->
											<!--begin::Product ID-->
										...
										<tr>
											<!--begin::Item-->
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-900 text-hover-primary">Logitech MX
													250</a>
											</td>
											<!--end::Item-->
											<!--begin::Product ID-->
										...
										<tr>
											<!--begin::Item-->
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-900 text-hover-primary">AudioEngine
													HD3</a>
											</td>
											<!--end::Item-->
											<!--begin::Product ID-->
										...
										<tr>
											<!--begin::Item-->
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-900 text-hover-primary">HP Hyper
													LTR</a>
											</td>
											<!--end::Item-->
											<!--begin::Product ID-->
										...
										<tr>
											<!--begin::Item-->
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-900 text-hover-primary">Dell 32
													UltraSharp</a>
											</td>
											<!--end::Item-->
											<!--begin::Product ID-->
										...
										<tr>
											<!--begin::Item-->
											<td>
												<a href="<?= url('/dw-admin/edit-product') ?>" class="text-gray-900 text-hover-primary">Google
													Pixel 6 Pro</a>
											</td>
											<!--end::Item-->
											<!--begin::Product ID-->
