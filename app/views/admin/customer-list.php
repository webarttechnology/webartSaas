							...
							<tbody class="fw-semibold text-gray-600">
								<?php foreach ($alluser as $user) : ?>
									<tr>
										...
										<td>
											<a href="view.php" class="text-gray-800 text-hover-primary mb-1"><?php echo $user->first_name ?> <?php echo $user->last_name ?></a>
										</td>
										<td>
											<a href="#" class="text-gray-600 text-hover-primary mb-1"><?php echo $user->email ?></a>
										</td>
										<td>Google</td>
										<td data-filter="visa">
											<img src="<?= url('/admin') ?>/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 4484
										</td>
								...
								<!-- <tr>
									...
									<td data-filter="mastercard">
										<img src="<?= url('/admin') ?>/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 3197
									</td>
								...
								<tr>
									...
									<td data-filter="american_express">
										<img src="<?= url('/admin') ?>/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 4990
									</td>
				...
				<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
					...
					<div class="modal-dialog modal-dialog-centered mw-650px">
						...
						<div class="modal-content">
							<!--begin::Form-->
							<form action="<?= url('dw-admin/save-user') ?>" method="POST" id="kt_modal_add_customer_form" class="form save-user" data-kt-redirect="<?= url('/dw-admin/customer-list') ?>" enctype="multipart/form-data">
								<?= csrf_field() ?>
								<!--begin::Modal header-->
