...
<head>
    ...
    <meta name="description" content="Your OTP for verification" />
    <style type="text/css">
        a:hover {
                ...
                <table width="100%" border="0" class="table1" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td style="text-align: center">
                            <!-- <a href="<?php url('/') ?>" title="logo" target="_blank">
                                <img width="300" src="" title="logo" alt="logo" />
                            </a> -->
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="tb2">
                                ...
                                <tr>
                                    <td style="padding: 0 35px">
                                        <h1 class="h1">Your Reset Link</h1>
                                        <strong>Hi, <?php echo $data['name'] ?></strong>
                                        </p>
                                        <span class="s1"></span>
                                        <p class="p2">
                                            <strong class="st2">OTP</strong>
                                            <br> <a href="<?= url($data['link']) ?>">Reset Link</a>
                                            <!-- <br><p><?php echo $data['link'] ?></p> -->
                                        </p>
                                    </td>
                                </tr>
                                <tr>
