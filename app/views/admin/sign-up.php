...
<base href="" />
	...
	<body id="kt_body" class="app-blank">
			...
			<div class="d-flex flex-column flex-lg-row flex-column-fluid">
				...
				<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
					...
					<div class="d-flex flex-center flex-column flex-lg-row-fluid">
						...
						<div class="w-lg-500px p-10">
							<!--begin::Form-->
							<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form" data-kt-redirect-url="<?= url('/dw-admin') ?>" action="#">
								<!--begin::Heading-->
								...
								<a href="<?= url('/dw-admin') ?>" class="link-primary fw-semibold">Sign in</a></div>
								<!--end::Sign up-->
							</form>
							<!--end::Form-->
						</div>
					...
					<div class="w-lg-500px d-flex flex-stack px-10 mx-auto">
						...
						<div class="me-10">
							...
							<button class="btn btn-flex btn-link btn-color-gray-700 btn-active-color-primary rotate fs-base" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start" data-kt-menu-offset="0px, 0px">
								<img data-kt-element="current-lang-flag" class="w-20px h-20px rounded me-3" src="<?= url('/admin/') ?>/assets/media/flags/united-states.svg" alt="" />
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-4 fs-7" data-kt-menu="true" id="kt_auth_lang_menu">
								...
								<div class="menu-item px-3">
									<a href="#" class="menu-link d-flex px-5" data-kt-lang="English">
										<span class="symbol symbol-20px me-4">
											<img data-kt-element="lang-flag" class="rounded-1" src="<?= url('/admin/') ?>/assets/media/flags/united-states.svg" alt="" />
										</span>
								...
								<div class="menu-item px-3">
									<a href="#" class="menu-link d-flex px-5" data-kt-lang="Spanish">
										<span class="symbol symbol-20px me-4">
											<img data-kt-element="lang-flag" class="rounded-1" src="<?= url('/admin/') ?>/assets/media/flags/spain.svg" alt="" />
										</span>
								...
								<div class="menu-item px-3">
									<a href="#" class="menu-link d-flex px-5" data-kt-lang="German">
										<span class="symbol symbol-20px me-4">
											<img data-kt-element="lang-flag" class="rounded-1" src="<?= url('/admin/') ?>/assets/media/flags/germany.svg" alt="" />
										</span>
								...
								<div class="menu-item px-3">
									<a href="#" class="menu-link d-flex px-5" data-kt-lang="Japanese">
										<span class="symbol symbol-20px me-4">
											<img data-kt-element="lang-flag" class="rounded-1" src="<?= url('/admin/') ?>/assets/media/flags/japan.svg" alt="" />
										</span>
								...
								<div class="menu-item px-3">
									<a href="#" class="menu-link d-flex px-5" data-kt-lang="French">
										<span class="symbol symbol-20px me-4">
											<img data-kt-element="lang-flag" class="rounded-1" src="<?= url('/admin/') ?>/assets/media/flags/france.svg" alt="" />
										</span>
				...
				<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2" style="background-image: url(<?= url('/admin/') ?>/assets/media/misc/auth-bg.png)">
					...
					<div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
						<!--begin::Logo-->
						<a href="index.php" class="mb-0 mb-lg-12" style="color:#fff; font-weight:bold; font-size:35px">
						Trixcart
						</a>
						<!--end::Logo-->
						<!--begin::Image-->
		...
		<script src="<?= url('/admin/') ?>/assets/js/custom/authentication/sign-up/general.js"></script>
