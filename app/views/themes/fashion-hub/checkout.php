        ...
        <div class="container">
            <form action="#" class="checkout-form">
                <div class="row">
                    ...
                    <div class="col-lg-9 account-page">
                        <div class="row ">
                            <div class="col-lg-2">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="payment-method">
                            <h3>Payment</h3>
                            <ul>
                                <li>Paypal <img src="<?= url('themes/'. $themeInfo->value)?>/img/paypal.jpg" alt=""></li>
                                <li>Credit / Debit card <img src="<?= url('themes/'. $themeInfo->value)?>/img/mastercard.jpg" alt=""></li>
                                <li>
