								...
								<?php foreach ($allcategory as $category) : ?>
									<tr>
										...
										<td>
											<div class="d-flex">
												<!--begin::Thumbnail-->
												<a href="<?= url('/dw-admin/edit-category/'.$category->id) ?>" class="symbol symbol-50px">
													<span class="symbol-label" style="background-image:url(<?php echo $category->image ?? url('/admin/assets/media/svg/files/blank-image.svg') ?>);"></span>
												</a>
												<!--end::Thumbnail-->
												<div class="ms-5">
													<!--begin::Title-->
										...
										<td>
											<!--begin::Badges-->
											<div class="badge badge-light-success"><?php echo $category->parent_name ?? "Main" ?></div>
											<!--end::Badges-->
										</td>
										<td>
											<!--begin::Badges-->
											<div class="badge <?php echo $category->status == 'Active' ? 'badge-light-success' : 'badge-light-danger'  ?>"><?php echo $category->status ?? "" ?></div>
											<!--end::Badges-->
										</td>
										<td class="text-end">
											...
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
												...
												<div class="menu-item px-3">
													<a href="<?= url('/dw-admin/edit-category/' . $category->id) ?>" class="menu-link px-3">Edit</a>
												</div>
												<!--end::Menu item-->
												<!--begin::Menu item-->
												<div class="menu-item px-3">
