								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="d-flex align-items-center gap-2 gap-lg-3">
										...
										<div class="m-0">
											...
											<!--end::Menu toggle-->
											<!--begin::Menu 1-->
											<div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_65a1214bc8126">
												<!--begin::Header-->
												<div class="px-7 py-5">
												...
												<div class="px-7 py-5">
													...
													<div class="mb-10">
														...
														<!--begin::Input-->
														<div>
															<select class="form-select form-select-solid" multiple="multiple" data-kt-select2="true" data-close-on-select="false" data-placeholder="Select option" data-dropdown-parent="#kt_menu_65a1214bc8126" data-allow-clear="true">
																<option></option>
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<tbody class="fw-semibold text-gray-600">
													<tr>
														...
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 4118</td>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="view.php" class="menu-link px-3">View</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Melody Macy</a>
														</td>
														<td>
														...
														<td>Google</td>
														<td data-filter="visa">
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 4484</td>
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Max Smith</a>
														</td>
														<td>
														...
														<td>Bistro Union</td>
														<td data-filter="mastercard">
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 3197</td>
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Sean Bean</a>
														</td>
														<td>
														...
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 4990</td>
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Brian Cox</a>
														</td>
														<td>
														...
														<td>-</td>
														<td data-filter="visa">
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 1822</td>
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Mikaela Collins</a>
														</td>
														<td>
														...
														<td>Saas themes</td>
														<td data-filter="american_express">
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 2602</td>
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Francis Mitcham</a>
														</td>
														<td>
														...
														<td>Paypal</td>
														<td data-filter="mastercard">
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 9444</td>
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Olivia Wild</a>
														</td>
														<td>
														...
														<td>-</td>
														<td data-filter="american_express">
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 3684</td>
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Neil Owen</a>
														</td>
														<td>
														...
														<td>Paramount</td>
														<td data-filter="visa">
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 9187</td>
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Dan Wilson</a>
														</td>
														<td>
														...
														<td data-filter="visa">
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/visa.svg" class="w-35px me-3" alt="" />**** 7720</td>
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Emma Bold</a>
														</td>
														<td>
														...
														<td data-filter="mastercard">
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/mastercard.svg" class="w-35px me-3" alt="" />**** 5871</td>
													...
													<tr>
														...
														<td>
															<a href="view.php" class="text-gray-800 text-hover-primary mb-1">Ana Crown</a>
														</td>
														<td>
														...
														<td data-filter="american_express">
														<img src="<?=  url('/admin') ?>/assets/media/svg/card-logos/american-express.svg" class="w-35px me-3" alt="" />**** 4278</td>
									...
									<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												<!--begin::Form-->
												<form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="<?= url('/dw-admin/customer-list') ?>">
													<!--begin::Modal header-->
