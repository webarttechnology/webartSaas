                        ...
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                <ul class="nav tabHead">
                                    ...
                                    <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#menu2">Unfulfilled</a>
                                    </li>
                                    <li class="nav-item">
                                    <a class="nav-link" data-bs-toggle="tab" href="#menu3">Unpaid</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#menu4">Open</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#menu5">Closed</a>
                                    </li>
                                </ul>
                            </div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="check19"></label>
                                                </div>
                                            </td>
                                            <td><strong><a href="<?= url('dw-admin/order-details') ?>">#PBC1805</a></strong></td>
                                            <td>Monday  at 10:24 pm</td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-check form-check-inline">
                                                    ...
                                                    <label class="form-check-label" for="check20"></label>
                                                </div>
                                            </td>
                                            <td><strong><a href="<?= url('dw-admin/order-details') ?>">#PBC1805</a></strong></td>
                                            <td>Monday  at 10:24 pm</td>
