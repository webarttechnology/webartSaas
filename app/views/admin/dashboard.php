			...
			<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
				...
				<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
					...
					<div class="d-flex align-items-center gap-2 gap-lg-3">
						...
						<a href="<?= url('/dw-admin/order-list'); ?>"
							class="btn btn-sm fw-bold btn-secondary">Manage Sales</a>
						<!--end::Secondary button-->
						<!--begin::Primary button-->
						<a href="<?= url('/dw-admin/add-product'); ?>"
								...
								<div class="card-header pt-5">
									...
									<div class="card-title d-flex flex-column">
										...
										<div class="d-flex align-items-center">
											...
											<!--begin::Amount-->
											<span
												class="fs-2hx fw-bold text-gray-900 me-2 lh-1 ls-n2">2,420</span>
											<!--end::Amount-->
											<!--begin::Badge-->
											<span class="badge badge-light-success fs-base">
												<i class="ki-duotone ki-arrow-up fs-5 text-success ms-n1">
									...
									<ul class="nav nav-pills nav-pills-custom mb-3">
										...
										<li class="nav-item mb-3 me-3 me-lg-6">
											...
											<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4"
												...
												<div class="nav-icon">
													<img alt=""
														src="<?= url('/admin/') ?>/assets/media/svg/products-categories/t-shirt.svg"
														class="" />
												</div>
												<!--end::Icon-->
												<!--begin::Subtitle-->
										...
										<li class="nav-item mb-3 me-3 me-lg-6">
											...
											<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
												...
												<div class="nav-icon">
													<img alt=""
														src="<?= url('/admin/') ?>/assets/media/svg/products-categories/gaming.svg"
														class="" />
												</div>
												<!--end::Icon-->
												<!--begin::Subtitle-->
										...
										<li class="nav-item mb-3 me-3 me-lg-6">
											...
											<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
												...
												<div class="nav-icon">
													<img alt=""
														src="<?= url('/admin/') ?>/assets/media/svg/products-categories/watch.svg"
														class="" />
												</div>
												<!--end::Icon-->
												<!--begin::Subtitle-->
										...
										<li class="nav-item mb-3 me-3 me-lg-6">
											...
											<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
												...
												<div class="nav-icon">
													<img alt=""
														src="<?= url('/admin/') ?>/assets/media/svg/products-categories/gloves.svg"
														class="nav-icon" />
												</div>
												<!--end::Icon-->
												<!--begin::Subtitle-->
										...
										<li class="nav-item mb-3">
											...
											<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4"
												...
												<div class="nav-icon">
													<img alt=""
														src="<?= url('/admin/') ?>/assets/media/svg/products-categories/shoes.svg"
														class="nav-icon" />
												</div>
												<!--end::Icon-->
												<!--begin::Subtitle-->
											...
											<div class="table-responsive">
												...
												<table
													...
													<tbody>
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/210.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
														...
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/215.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
														...
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/209.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
											...
											<div class="table-responsive">
												...
												<table
													...
													<tbody>
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/197.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
														...
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/178.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
														...
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/22.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
											...
											<div class="table-responsive">
												...
												<table
													...
													<tbody>
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/1.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
														...
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/24.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
														...
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/71.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
											...
											<div class="table-responsive">
												...
												<table
													...
													<tbody>
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/41.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
														...
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/63.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
														...
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/59.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
											...
											<div class="table-responsive">
												...
												<table
													...
													<tbody>
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/10.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
														...
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/96.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
														...
														<tr>
															<td>
																<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/13.png"
																	class="w-50px ms-n1" alt="" />
															</td>
															<td class="ps-0">
																<a href="<?=  url('/dw-admin/edit-product') ?>"
								...
								<div class="card-body d-flex flex-column flex-center">
									...
									<div class="mb-2">
										...
										<div class="py-10 text-center">
											<img src="<?= url('/admin/') ?>/assets/media/svg/illustrations/easy/2.svg"
												class="theme-light-show w-200px" alt="" />
											<img src="<?= url('/admin/') ?>/assets/media/svg/illustrations/easy/2-dark.svg"
									...
									<div class="text-center mb-1">
										...
										<a class="btn btn-sm btn-primary me-2"
											href="<?=  url('/dw-admin/product') ?>">View App</a>
										<!--end::Link-->
										<!--begin::Link-->
										<a class="btn btn-sm btn-light"
											href="<?=  url('/dw-admin/add-product') ?>">New Product</a>
										<!--end::Link-->
									</div>
									<!--end::Links-->
								</div>
												...
												<td colspan="2">
													<div class="d-flex align-items-center gap-3">
														<a href="#"
															...
															<img src=""
																data-kt-src-path="<?= url('/admin/') ?>/assets/media/stock/ecommerce/"
																alt=""
									...
									<div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
										...
										<div
											...
											<div class="d-flex flex-stack mb-3">
												...
												<div class="me-3">
													<!--begin::Icon-->
													<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/214.png"
														class="w-50px ms-n1 me-1" alt="" />
													<!--end::Icon-->
													<!--begin::Title-->
													<a href="<?=  url('/dw-admin/edit-product') ?>"
										...
										<div
											...
											<div class="d-flex flex-stack mb-3">
												...
												<div class="me-3">
													<!--begin::Icon-->
													<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/211.png"
														class="w-50px ms-n1 me-1" alt="" />
													<!--end::Icon-->
													<!--begin::Title-->
													<a href="<?=  url('/dw-admin/edit-product') ?>"
										...
										<div class="border border-dashed border-gray-300 rounded px-7 py-3">
											...
											<div class="d-flex flex-stack mb-3">
												...
												<div class="me-3">
													<!--begin::Icon-->
													<img src="<?= url('/admin/') ?>/assets/media/stock/ecommerce/192.png"
														class="w-50px ms-n1 me-1" alt="" />
													<!--end::Icon-->
													<!--begin::Title-->
													<a href="<?=  url('/dw-admin/edit-product') ?>"
