                                                ...
                                                if (response.data.status == "success") {
                                                    t.reset(),
                                                        ...
                                                        Swal.fire({
                                                            ...
                                                            if (result.isConfirmed && response.data.url) {
                                    ...
                                    ? (e.setAttribute("data-kt-indicator", "on"),
                                        ...
                                        setTimeout(function () {
                                            e.removeAttribute("data-kt-indicator"),
                                                (e.disabled = !1),
                                                Swal.fire({ text: "We have send a password reset link to your email.", icon: "success", buttonsStyling: !1, confirmButtonText: "Ok, got it!", customClass: { confirmButton: "btn btn-primary" } }).then(
                                                    function (e) {
                                                        if (e.isConfirmed) {
