    ...
    <div class="container">
        ...
        <div class="row" id="product-list">
            <?php foreach ($product as $data) : ?>
                <div class="col-lg-3 col-sm-6 mix all <?php echo $data->categoryname ?>">
                    <div class="single-product-item">
                        <figure>
                            <!-- <a href="#"><img src="<?= url('themes/' . $themeInfo->value) ?>/img/products/img-1.jpg" alt=""></a> -->
                            <a href="#"><img src="<?php echo $data->thumb_img ?? url('/admin/assets/media/svg/files/blank-image.svg') ?>" alt=""></a>
                           
                            <div class="p-status">new</div>
                            <a href="#" class="primary-btn btn-sm pc-btn"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                        </figure>
                        <div class="product-text">
                            <h6><?php echo ucfirst($data->name) ?></h6>
            ...
            <?php endforeach ?>
            <!-- <div class="col-lg-3 col-sm-6 mix all Electronics bags">
                    <div class="single-product-item">
                        <figure>
