	...
	<div class="d-flex flex-column flex-column-fluid">
		...
		<div id="kt_app_content" class="app-content flex-column-fluid">
			...
			<div id="kt_app_content_container" class="app-container container-xxl">
				<form action="<?= url('/dw-admin/update-category'); ?>" method="POST" id="kt_ecommerce_edit_category_form" class="form d-flex flex-column flex-lg-row save-category" enctype="multipart/form-data">
					<?php echo csrf_field() ?>
					<input type="hidden" name="category_id" value="<?php echo $category[0]->id ?>" id="category_id">
					<input type="hidden" name="old_img" value="<?php echo $category[0]->image ?? null ?>">
					<!--begin::Aside column-->
						...
						<div class="card card-flush py-4">
							...
							<div class="card-body text-center pt-0">
								...
								<div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
									...
									<div class="image-input-wrapper w-150px h-150px" style="background-image: url(<?php echo $category[0]->image ?? url('/admin/assets/media/svg/files/blank-image.svg') ?>)"></div>
						...
						<div class="card card-flush py-4">
							...
							<div class="card-body pt-0">
								...
								<select class="form-select mb-2" name="status" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
									<option></option>
									<option value="Active" <?php echo ($category[0]->status == 'Active') ? 'selected="selected"' : ''; ?>>Active</option>
									<option value="Inactive" <?php echo ($category[0]->status == 'Inactive') ? 'selected="selected"' : ''; ?>>Inactive</option>
								</select>
								<!--end::Select2-->
								<!--begin::Description-->
						...
						<div class="card card-flush py-4">
							...
							<div class="card-body pt-0">
								...
								<div class="mb-10 fv-row">
									...
									<!--end::Label-->
									<!--begin::Input-->
									<input type="text" name="category" class="form-control mb-2" placeholder="Product name" value="<?php echo $category[0]->name ?>" />
									<!--end::Input-->
									<!--begin::Description-->
								...
								<div class="mb-10 fv-row">
									...
									<select class="form-control sub_category" name="sub_category[]" id="sub_category">
										...
										<?php foreach ($categories as $item) : ?>
											<option value="<?php echo $item->id ?>" <?php echo ($item->id == $category[0]->parent_id) ? 'selected' : ''; ?>><?php echo $item->name ?></option>
										<?php endforeach ?>
									</select>
									<!--end::Input-->
								</div>
