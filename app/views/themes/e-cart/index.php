<?php include("header.php") ?>
        ...
        <section class="welcome_area">
            <div class="welcome_slides owl-carousel">
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(<?= url('themes/'. $themeInfo->value)?>/img/bg-img/bg-1.jpg);">
                ...
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(<?= url('themes/'. $themeInfo->value)?>/img/bg-img/bg-4.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
                ...
                <!-- Single Slide Start -->
                <div class="single_slide height-800 bg-img background-overlay" style="background-image: url(<?= url('themes/'. $themeInfo->value)?>/img/bg-img/bg-2.jpg);">
                    <div class="container h-100">
                        <div class="row h-100 align-items-center">
                            <div class="col-12">
                                <div class="welcome_slide_text">
        ...
        <section class="top_catagory_area d-md-flex clearfix">
            <!-- Single Catagory -->
            <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url(<?= url('themes/'. $themeInfo->value)?>/img/bg-img/bg-2.jpg);">
            ...
            <!-- Single Catagory -->
            <div class="single_catagory_area d-flex align-items-center bg-img" style="background-image: url(<?= url('themes/'. $themeInfo->value)?>/img/bg-img/bg-3.jpg);">
                <div class="catagory-content">
            ...
            <div class="container">
                <div class="row karl-new-arrivals">
                    ...
                    <div class="col-12 col-sm-6 col-md-4 single_gallery_item kids man wow fadeInUpBig" data-wow-delay="0.7s">
                        <!-- Product Image -->
                        <div class="product-img">
                            <img src="<?= url('themes/'. $themeInfo->value)?>/img/product-img/product-6.jpg" alt="">
                            <div class="product-quicview">
                                <a href="#" data-toggle="modal" data-target="#quickview"><i class="ti-plus"></i></a>
                            </div>
                        </div>
        ...
        <!-- ****** Offer Area Start ****** -->
        <section class="offer_area height-700 section_padding_100 bg-img" style="background-image: url(<?= url('themes/'. $themeInfo->value)?>/img/bg-img/bg-5.jpg);">
            <div class="container h-100">
                            ...
                            <div class="single-testimonial-area text-center">
                                ...
                                <div class="testimonial-info d-flex align-items-center justify-content-center">
                                    <div class="tes-thumbnail">
                                        <img src="<?= url('themes/'. $themeInfo->value)?>/img/bg-img/tes-1.jpg" alt="">
                                    </div>
