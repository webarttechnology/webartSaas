  ...
  <nav class="">
      ...
      <ul class="accordion" id="myAccordion">
          <li class="accordion-item <?= isCurrentPage('dashboard') ?>">
          ...
          <li class="accordion-item">
              <h2 class="accordion-header <?= isCurrentPages(['product', 'add-product-category']) ?>" id="headingProducts">
          ...
          <li class="accordion-item <?= isCurrentPage('order-list') ?>">
              <h2 class="accordion-header" id="headingOne">
          ...
          <li class="accordion-item <?= isCurrentPages(['customer-list', 'order-history']) ?>">
          ...
          <li class="accordion-item <?= isCurrentPage('theme') ?>">
          ...
          <li class="accordion-item <?= isCurrentPage('settings') ?>">
